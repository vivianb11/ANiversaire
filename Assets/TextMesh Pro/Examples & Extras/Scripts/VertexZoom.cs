...
namespace TMPro.Examples
{
    ...
    public class VertexZoom : MonoBehaviour
    {
        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            // We throwForce an update of the text object since it would only be updated at the end of the frame. Ie. before this code is executed on the first frame.
            ...
            while (true)
            {
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    //Vector3 jitterOffset = new Vector3(RandomClip.Range(-.25f, .25f), RandomClip.Range(-.25f, .25f), 0);
                    ...
                    //matrix = Matrix4x4.TRS(jitterOffset, Quaternion.Euler(0, 0, RandomClip.Range(-5f, 5f)), Vector3.one * randomScale);
